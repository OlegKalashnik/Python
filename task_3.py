...
# Отсортировать то не проблема, а куда распаковку пристроить не придумал
def thesaurus(*args):
    workers = {}
    for name in sorted(args):
        workers.setdefault(name[0], []).append(name)
    return workers


print(thesaurus("Яков", "Олег", "Марат", "Василий", "Иван", "Игнат", "Мария", "Петр", "Илья"))
